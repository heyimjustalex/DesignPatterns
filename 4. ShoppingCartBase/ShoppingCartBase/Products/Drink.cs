...
namespace ShoppingCartVisitorExample.Products
{
    public class Drink : ProductBase
    {
        ...
        public Drink(int code, string name, string description, string category, int volumeInMilliliters, double price, string flavor) : base(code, name, description, category, price  )
        {
